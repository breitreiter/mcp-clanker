...
//   - Run    — synthesises a per-target brief, dispatches ResearchRunner.RunAsync
...
public static class WikiRunner
{
    ...
    // Pull terminal_state out of the JSON envelope returned by ResearchRunner.RunAsync.
